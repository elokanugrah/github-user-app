...
class FollowerViewModel internal constructor(
    private val repository: GithubRepository
) : ViewModel() {
    private var currentQueryValue: String? = null
    private var currentSearchResult: Flow<PagingData<Item>>? = null

    fun userFollower(username: String): Flow<PagingData<Item>> {
        ...
        val newResult: Flow<PagingData<Item>> =
            repository.getFollowerStream(username).cachedIn(viewModelScope)
